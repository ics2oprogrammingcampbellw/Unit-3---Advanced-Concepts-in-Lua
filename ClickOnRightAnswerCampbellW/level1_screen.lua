...
function scene:create( event )
    ...
    correct = display.newText("Correct", display.contentWidth/2, display.contentHeight*2/5, nil, 50 )
    correct:setTextColor(100/255, 47/255, 210/255)
    correct.isVisible = false

    incorrect = display.newText("incorrect!", display.contentWidth/2, display.contentHeight*2/5, nil, 50 )
